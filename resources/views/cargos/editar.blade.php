	...
	<?php $id_usr = Auth::user()->tipo_user; ?>
        ...
        <div class="col-md-12">
            ...
            <div class="">
               ...
               <form method="POST" action="{{ route('update_cargo', $cargo->id) }}">								
       		    ...
       		    <input type="hidden" name="_token" value="{{ csrf_token() }}" required>
								...
								<div class="col-md-10">
									<label>Nombre</label>
									<input type="text" name="nombre" class="form-control" value="{{$cargo->nombre}}" class="form-control">
                      ...
                      @endif
								...
								<div class="row">
									...
									<div class="col-lg-12" style="margin: 15px;">
										<button class="btn btn-success" class="form-control" type="submit">Actualizar Cargo</button>
									</div>
